...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/my_catppuccin/theme.lua")
...
myawesomemenu = {
   ...
   { "restart", function() awful.util.spawn("reboot") end },
}
...
local bat = lain.widget.bat({
    settings = function()
      if bat_now.perc ~= "N/A" then
        ...
        widget:set_markup(markup.font(beautiful.font, bat_p))
      end
    end
})
